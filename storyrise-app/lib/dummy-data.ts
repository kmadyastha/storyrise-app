export const heroStates = [
  {
    ...
    headline: "Turn any idea into a personalized storybook",
    sub: "Pick a genre, an age group, and let StoryRise write it.",
  },
  {
    key: "lime",
    ...
    headline: "Characters that stay consistent, cover to cover",
    sub: "Not just one hero — your whole cast, recognizable throughout.",
  },
  {
    key: "green",
    ...
    headline: "Export a KDP-ready book in minutes",
    sub: "Real trim sizes, real spines, ready for Amazon.",
  },
  {
    key: "tangerine",
    color: "var(--color-tangerine)",
    text: "var(--color-tangerine-text)",
    tint: "var(--color-tangerine-tint)",
    headline: "Narrated video, straight from your story",
    sub: "Every page voiced, every scene animated.",
  },
] as const;
