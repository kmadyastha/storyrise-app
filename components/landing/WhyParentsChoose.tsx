      ...
      <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-14 items-center">
        <div className="relative order-2 lg:order-1">
          <img
            ...
            className="w-full h-auto block drop-shadow-[0_30px_60px_rgba(0,0,0,0.18)]"
          />
        ...
        <div className="order-1 lg:order-2">
          ...
          <h2 className="font-fredoka font-bold text-3xl sm:text-4xl text-[#1a1a1a] mb-5 leading-[1.1] whitespace-nowrap max-sm:whitespace-normal">
