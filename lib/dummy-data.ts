...
export const exportOptions = [
  ...
  { id: "kdp", label: "KDP print file", desc: "Trim, spine & barcode-ready.", minPages: 24 },
  ...
  { id: "flipbook", label: "Flipbook (HTML)", desc: "Flip through offline, forever.", always: true },
  { id: "audiobook", label: "Audiobook", desc: "Every page's narration, one listen.", always: true },
